import { FaPhone, FaShieldAlt, FaPaypal } from "react-icons/fa";
const InfoProduct = () => {
    return (
        <div className="mt-4 p-2 border-[1px] rounded-borderContnet">
            ...
            <div className="flex flex-col gap-2 ">
                ...
                <div className="flex gap-4 items-center text-[#4a4a4a] opacity-[.9]">
                    <FaShieldAlt />
                    <span className="text-sm font-medium">
                        Bảo hành 18 tháng tại trung tâm bảo hành Chính hãng. 1
                        đổi 1 trong 30 ngày nếu có lỗi phần cứng từ nhà sản
                        xuất. (xem chi tiết)
                    </span>
                </div>
                <div className="flex gap-4 items-center text-[#4a4a4a] opacity-[.9]">
