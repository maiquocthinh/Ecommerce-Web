    ...
    return (
        <div className="flex flex-col">
            <div className="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32">
                <button onClick={() => route("/")} className="text-2xl font-bold text-gray-800">E-commerce</button>
            ...
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                <div className="px-4 pt-8">
                    ...
                    <p className="text-gray-400">Kiểm tra các mục của bạn. Và lựa chọn phương thức vận chuyển phù hợp.</p>
                            ...
                            <label className="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" htmlFor="radio_1">
                                <div className="flex gap-4 items-center">
                                    ...
                                    <div className="flex-1">
                                        <span className="mt-2 font-semibold">Chuyển phát nhanh</span>
                                        <p className="text-slate-500 text-sm leading-6">Giao hàng: 2-4 ngày</p>
                                    </div>
                                </div>
                            </label>
                        </div>
                        <div className="relative">
                            ...
                            <label className="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" htmlFor="radio_2">
                                <div className="flex gap-4 items-center">
                                    <GrDeliver className="text-2xl" />
                                    <div className="flex-1">
                                        <span className="mt-2 font-semibold">Giao hàng phổ thông</span>
                                        <p className="text-slate-500 text-sm leading-6">Giao hàng: 4-6 ngày</p>
                                    </div>
                                </div>
                            </label>
                        </div>
                ...
                <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    ...
                    <div className="">
                        ...
                        <label htmlFor="card-holder" className="mt-4 mb-2 block text-sm font-medium">Tên chủ thẻ</label>
                        <div className="relative">
                        ...
                        <label htmlFor="card-no" className="mt-4 mb-2 block text-sm font-medium">chi tiêt thẻ
                        </label>
                        <div className="flex">
                        ...
                        <label htmlFor="billing-address" className="mt-4 mb-2 block text-sm font-medium">Địa chỉ thanh toán</label>
                        <div className="flex flex-col sm:flex-row">
                            <div className="relative flex-shrink-0 sm:w-7/12">
                                <input type="text" id="billing-address" name="billing-address" className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="địa chỉ nhà" />
                                <div className="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                                    <img className="h-4 w-4 object-contain" src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Flag_of_Vietnam.svg/1200px-Flag_of_Vietnam.svg.png" alt="" />
                                </div>
                            </div>
